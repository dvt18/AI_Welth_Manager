/**
 * Arya — AI Wealth Advisor (IDBI Innovate 2026) — WEB EDITION
 * Self-contained dummy data. Same persona (Priya, 28, Bengaluru).
 * All figures illustrative — sandbox APIs will replace in Phase 2.
 */
...
const AryaData = {
  ...
  retirement: {
    ...
    nps: { balance: 0, tier1Active: false, deductionGap80CCD1B: 50000 },
  },
  ...
  retirementPlan: {
    currentCorpus: 415000,
    targetAtAge60: 40000000,
  ...
  chatScripts: [
    ...
    },
    {
      ...
      bubbles: [
        { type: "text", text: "Two quick wins on tax for FY 2026-27:" },
        {
          type: "list",
          items: [
    ...
    },
    {
      ...
      bubbles: [
        {
          type: "text",
          text: "I found ₹48,760/yr you can save right now — with zero effort from you. Details in the Bill Negotiator, but here's the summary:",
        },
        {
          type: "list",
          items: [
